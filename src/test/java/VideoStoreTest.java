...
public class VideoStoreTest extends TestCase
{
	...
	public void testSingleChildrensStatement () {
		customer.addRental (new Rental (new Movie ("The Tigger Movie", new Price(Movie.CHILDRENS)), 3));
		assertEquals ("Rental Record for Fred\n\tThe Tigger Movie\t1.5\nYou owed 1.5\nYou earned 1 frequent renter points\n", customer.statement ());
	}
	
	public void testMultipleRegularStatement () {
		customer.addRental (new Rental (new Movie ("Plan 9 from Outer Space", new Price(Movie.REGULAR)), 1));
		customer.addRental (new Rental (new Movie ("8 1/2", new Price(Movie.REGULAR)), 2));
		customer.addRental (new Rental (new Movie ("Eraserhead", new Price(Movie.REGULAR)), 3));
